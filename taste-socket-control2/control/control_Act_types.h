...
#ifndef typedef_struct_T_control_Act_c_T
#define typedef_struct_T_control_Act_c_T

typedef struct {
  char_T f0[6];
  char_T f1[6];
} struct_T_control_Act_c_T;

#endif                                 /*typedef_struct_T_control_Act_c_T*/

#ifndef typedef_struct_T_control_Act_cb_T
#define typedef_struct_T_control_Act_cb_T

typedef struct {
  char_T f0[2];
} struct_T_control_Act_cb_T;

#endif                                 /*typedef_struct_T_control_Act_cb_T*/
