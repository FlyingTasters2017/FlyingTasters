#ifndef GENERATED_ASN1SCC_TASTE_SOCKET_CONTROL3_H
#define GENERATED_ASN1SCC_TASTE_SOCKET_CONTROL3_H
/*
...
#ifndef ERR_MyReal 
#define ERR_MyReal		1001  /*(-1.00000000000000000000E+003 .. 1.00000000000000000000E+005)*/
#endif
...
#define MySensorData_REQUIRED_BYTES_FOR_ENCODING       91 
#define MySensorData_REQUIRED_BITS_FOR_ENCODING        728
#define MySensorData_REQUIRED_BYTES_FOR_ACN_ENCODING   91 
#define MySensorData_REQUIRED_BITS_FOR_ACN_ENCODING    728
#define MySensorData_REQUIRED_BYTES_FOR_XER_ENCODING   514

void MySensorData_Initialize(MySensorData* pVal);
flag MySensorData_IsConstraintValid(const MySensorData* val, int* pErrCode);
flag MySensorData_Equal(const MySensorData* val1, const MySensorData* val2);
...
#define MyDroneData_REQUIRED_BYTES_FOR_ENCODING       52 
#define MyDroneData_REQUIRED_BITS_FOR_ENCODING        416
#define MyDroneData_REQUIRED_BYTES_FOR_ACN_ENCODING   52 
#define MyDroneData_REQUIRED_BITS_FOR_ACN_ENCODING    416
#define MyDroneData_REQUIRED_BYTES_FOR_XER_ENCODING   315

void MyDroneData_Initialize(MyDroneData* pVal);
flag MyDroneData_IsConstraintValid(const MyDroneData* val, int* pErrCode);
flag MyDroneData_Equal(const MyDroneData* val1, const MyDroneData* val2);
...
flag MySensorData_Encode(const MySensorData* val, BitStream* pBitStrm, int* pErrCode, flag bCheckConstraints);
flag MySensorData_Decode(MySensorData* pVal, BitStream* pBitStrm, int* pErrCode);
flag MySensorData_ACN_Encode(const MySensorData* val, BitStream* pBitStrm, int* pErrCode, flag bCheckConstraints);
flag MySensorData_ACN_Decode(MySensorData* pVal, BitStream* pBitStrm, int* pErrCode);
flag MyDroneData_Encode(const MyDroneData* val, BitStream* pBitStrm, int* pErrCode, flag bCheckConstraints);
flag MyDroneData_Decode(MyDroneData* pVal, BitStream* pBitStrm, int* pErrCode);
flag MyDroneData_ACN_Encode(const MyDroneData* val, BitStream* pBitStrm, int* pErrCode, flag bCheckConstraints);
