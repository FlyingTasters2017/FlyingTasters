...
void controlAction_step(void)
{
  ...
  /* Gain: '<S1>/Gain1' */
  rtb_Gain1 = -18.0 * controlAction_B.sf_DeadZone.error_dz;
   ...
   */
  rtb_TSamp = controlAction_B.sf_DeadZone.error_dz * -250.0;
   ...
   *  y = u * K where K = 1 / ( w * Ts )
   */
  rtb_XError = controlAction_B.sf_DeadZone1.error_dz * -250.0;
   ...
   *  Sum: '<S2>/Sum'
   */
  rtb_sinpsi = (0.0 - controlAction_U.sensorData.yawAct) * -0.5;
  ...
  if (rtb_sinpsi > 30.0) {
    ...
    /* Outport: '<Root>/droneData' */
    controlAction_Y.droneData.yawrateRef = rtb_sinpsi;
  }
   ...
   *  Store in Global RAM
   */
  rtb_sinpsi = (rtb_TSamp - controlAction_DW.UD_DSTATE) + rtb_Gain1;
  ...
  if (rtb_sinpsi > 10.0) {
    ...
    /* Outport: '<Root>/droneData' */
    controlAction_Y.droneData.pitchRef = rtb_sinpsi;
  }
   ...
   *  Store in Global RAM
   */
  rtb_sinpsi = -18.0 * controlAction_B.sf_DeadZone1.error_dz + (rtb_XError -
  ...
  if (rtb_sinpsi > 10.0) {
    ...
    /* Outport: '<Root>/droneData' */
    controlAction_Y.droneData.rollRef = rtb_sinpsi;
  }
   ...
   */
  controlAction_Y.droneData.zRef = controlAction_U.refData.zAct;
