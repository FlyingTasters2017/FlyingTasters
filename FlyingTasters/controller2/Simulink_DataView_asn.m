...
MyPositionControlData_elem03=Simulink.BusElement;
MyPositionControlData_elem03.name='zAct';
MyPositionControlData_elem03.DataType='double';
MyPositionControlData_elem03.dimensions=1;

MyPositionControlData = Simulink.Bus;
MyPositionControlData.Elements = [MyPositionControlData_elem01 MyPositionControlData_elem02 MyPositionControlData_elem03 ];
