...
types["MyDroneData"] = type("MyDroneData", (object,), {
    "Line": 46, "CharPositionInLine": 0, "type": type("MyDroneData_type", (object,), {
        "Line": 46, "CharPositionInLine": 16, "kind": "SequenceType", "Children": {
            "yawrateRef": type("yawrateRef", (object,), {
                "Optional": "False", "Line": 47, "CharPositionInLine": 4, "type": type("yawrateRef_type", (object,), {
                    "Line": 47, "CharPositionInLine": 15, "kind": "ReferenceType", "ReferencedTypeName": "MyReal", "Min": "-1000", "Max": "100000"
                })
            }),
            "pitchRef": type("pitchRef", (object,), {
                "Optional": "False", "Line": 48, "CharPositionInLine": 4, "type": type("pitchRef_type", (object,), {
            ...
            "rollRef": type("rollRef", (object,), {
                "Optional": "False", "Line": 49, "CharPositionInLine": 4, "type": type("rollRef_type", (object,), {
            ...
            "thrustRef": type("thrustRef", (object,), {
                "Optional": "False", "Line": 50, "CharPositionInLine": 4, "type": type("thrustRef_type", (object,), {
                    "Line": 50, "CharPositionInLine": 14, "kind": "ReferenceType", "ReferencedTypeName": "MyReal", "Min": "-1000", "Max": "100000"
                })
            })
        }
    })
...
types["MyChoice"] = type("MyChoice", (object,), {
    "Line": 53, "CharPositionInLine": 0, "type": type("MyChoice_type", (object,), {
        "Line": 53, "CharPositionInLine": 16, "kind": "ChoiceType", "Children": {
            "a": type("a_PRESENT", (object,), {
                "Line": 54, "CharPositionInLine": 4, "EnumID": "a_PRESENT", "type": type("a_PRESENT_type", (object,), {
                    "Line": 54, "CharPositionInLine": 6, "kind": "BooleanType"
                })
            }),
            "b": type("b_PRESENT", (object,), {
                "Line": 55, "CharPositionInLine": 4, "EnumID": "b_PRESENT", "type": type("b_PRESENT_type", (object,), {
                    "Line": 55, "CharPositionInLine": 6, "kind": "ReferenceType", "ReferencedTypeName": "MySeq"
                })
            })
        }
    })
...
types["MySeqOf"] = type("MySeqOf", (object,), {
    "Line": 58, "CharPositionInLine": 0, "type": type("MySeqOf_type", (object,), {
        "Line": 58, "CharPositionInLine": 16, "kind": "SequenceOfType", "Min": "2", "Max": "2", "type": type("SeqOf_type", (object,), {
            "Line": 58, "CharPositionInLine": 39, "kind": "ReferenceType", "ReferencedTypeName": "MyEnum"
        })
    })
})

types["MyOctStr"] = type("MyOctStr", (object,), {
    "Line": 60, "CharPositionInLine": 0, "type": type("MyOctStr_type", (object,), {
        "Line": 60, "CharPositionInLine": 16, "kind": "OctetStringType", "Min": "3", "Max": "3"
    })
})
...
variables["myVar"] = type("myVar", (object,), {
    ...
    "type": type("myVar_type", (object,), {
        "Line": 63, "CharPositionInLine": 12, "kind": "ReferenceType", "ReferencedTypeName": "MySeqOf", "Min": "2", "Max": "2"
    }),
    "value": {"hello", "world"}
})
