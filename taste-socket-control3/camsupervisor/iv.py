...
functions['supervisor']['interfaces']['printTime'] = {
    'port_name': 'printTime',
    'parent_fv': 'supervisor',
    'direction': RI,
    'in': {},
...
functions['supervisor']['interfaces']['printTime']['paramsInOrdered'] = []

functions['supervisor']['interfaces']['printTime']['paramsOutOrdered'] = []
