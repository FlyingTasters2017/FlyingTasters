...
# Generate code for OpenGEODE function interruptor
cd "$SKELS"/interruptor && opengeode --toAda interruptor.pr system_structure.pr && cd $OLDPWD
...
cd "$SKELS" && rm -f interruptor.zip && zip interruptor interruptor/* && cd $OLDPWD
...
cd "$CWD" && assert-builder-ocarina.py \
	...
	--subAda interruptor:"$SKELS"/interruptor.zip \
