...
void function1_RI_check_queue(asn1SccT_Boolean *OUT_res)
{
#ifdef __unix__
    ...
    if (1 == innerMsc) {
        ...
        printf ("\nINNER: function1,x86_partition_taste_api,check_queue,%lld\n", msc_time);
        fflush(stdout);
    }
#endif
    ...
    extern void vm_function1_check_queue(void *, size_t *);

    vm_function1_check_queue(OUT_buf_res, &size_OUT_buf_res);
