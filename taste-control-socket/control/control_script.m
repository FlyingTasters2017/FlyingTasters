...
if inports_positions(1)>0
	set_param('controlAction/sensorData','Position', inports_positions(1,:));
else
	set_param('controlAction/sensorData','Position',[25 25 55 39]);
end
...
if bussel_positions(1)>0
	set_param('controlAction/sensorData_MySensorData_BusSel','Position', bussel_positions(1,:));
else
	set_param('controlAction/sensorData_MySensorData_BusSel','Position',[95 6 100 44]);
end
