...
__po_hi_entity_t __po_hi_port_global_to_entity[__PO_HI_NB_PORTS] = {x86_partition_vt_obsw_pulse_k_entity,x86_partition_vt_obsw_takeoff_k_entity,x86_partition_vt_obsw_takeoff_k_entity,x86_partition_vt_ground_getheight_k_entity,x86_partition_vt_ground_getheight_k_entity,x86_partition_vt_ground_gui_polling_ground_k_entity};
char* __po_hi_port_global_names[__PO_HI_NB_PORTS] = {"vt_obsw_pulse_global_outport_getheight_vt","vt_obsw_takeoff_global_inport_artificial_takeoff","vt_obsw_takeoff_global_outport_getheight_vt","vt_ground_getheight_global_inport_artificial_getheight","vt_ground_getheight_global_outport_takeoff_vt","vt_ground_gui_polling_ground_global_outport_takeoff_vt"};
char* __po_hi_port_global_model_names[__PO_HI_NB_PORTS] = {"outport_getheight_vt","inport_artificial_takeoff","outport_getheight_vt","inport_artificial_getheight","outport_takeoff_vt","outport_takeoff_vt"};
...
__po_hi_local_port_t __po_hi_port_global_to_local[__PO_HI_NB_PORTS] = {vt_obsw_pulse_local_outport_getheight_vt,vt_obsw_takeoff_local_inport_artificial_takeoff,vt_obsw_takeoff_local_outport_getheight_vt,vt_ground_getheight_local_inport_artificial_getheight,vt_ground_getheight_local_outport_takeoff_vt,vt_ground_gui_polling_ground_local_outport_takeoff_vt};
