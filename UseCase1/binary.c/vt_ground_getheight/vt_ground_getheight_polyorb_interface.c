...
void vm_async_vt_ground_getheight_Takeoff_vt(void *ReferenceHeight, size_t ReferenceHeight_len)
{
	...
	__po_hi_copy_array(&(request.vars.vt_ground_getheight_global_outport_takeoff_vt.vt_ground_getheight_global_outport_takeoff_vt.buffer), ReferenceHeight, ReferenceHeight_len);
	request.vars.vt_ground_getheight_global_outport_takeoff_vt.vt_ground_getheight_global_outport_takeoff_vt.length = ReferenceHeight_len;
