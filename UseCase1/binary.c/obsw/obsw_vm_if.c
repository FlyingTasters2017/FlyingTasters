...
void obsw_Takeoff (void *pmy_ReferenceHeight, size_t size_my_ReferenceHeight)
{
    /* Decoded input variable(s): developer can use them */
    static asn1SccMyReal IN_ReferenceHeight;
    ...
    if (0 != Decode_UPER_MyReal (&IN_ReferenceHeight, pmy_ReferenceHeight, size_my_ReferenceHeight)) {
        #ifdef __unix__
    ...
    /* Call to User-defined function */
    obsw_PI_Takeoff (&IN_ReferenceHeight);
