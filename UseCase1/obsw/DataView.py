...
types["MyReal"] = type("MyReal", (object,), {
    "Line": 25, "CharPositionInLine": 0, "type": type("MyReal_type", (object,), {
        "Line": 25, "CharPositionInLine": 16, "kind": "RealType", "Min": "-1.00000000000000000000E+005", "Max": "1.00000000000000000000E+006"
    })
})
    ...
    "Line": 39, "CharPositionInLine": 0, "type": type("MyChoice_type", (object,), {
        "Line": 39, "CharPositionInLine": 16, "kind": "ChoiceType", "Children": {
            "a": type("a_PRESENT", (object,), {
                "Line": 40, "CharPositionInLine": 4, "EnumID": "a_PRESENT", "type": type("a_PRESENT_type", (object,), {
                    "Line": 40, "CharPositionInLine": 6, "kind": "BooleanType"
                })
            }),
            "b": type("b_PRESENT", (object,), {
                "Line": 41, "CharPositionInLine": 4, "EnumID": "b_PRESENT", "type": type("b_PRESENT_type", (object,), {
                    "Line": 41, "CharPositionInLine": 6, "kind": "ReferenceType", "ReferencedTypeName": "MySeq"
                })
            })
        }
    })
...
types["MyOctStr"] = type("MyOctStr", (object,), {
    "Line": 46, "CharPositionInLine": 0, "type": type("MyOctStr_type", (object,), {
        "Line": 46, "CharPositionInLine": 16, "kind": "OctetStringType", "Min": "3", "Max": "3"
    })
})
...
variables["myVar"] = type("myVar", (object,), {
    ...
    "type": type("myVar_type", (object,), {
        "Line": 49, "CharPositionInLine": 12, "kind": "ReferenceType", "ReferencedTypeName": "MySeqOf", "Min": "2", "Max": "2"
    }),
    "value": {"hello", "world"}
})
