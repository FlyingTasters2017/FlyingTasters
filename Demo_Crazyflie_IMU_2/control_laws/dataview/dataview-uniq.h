...
typedef double asn1SccMyGyroVal;

#define asn1SccMyGyroVal_REQUIRED_BYTES_FOR_ENCODING       13 
#define asn1SccMyGyroVal_REQUIRED_BITS_FOR_ENCODING        104
#define asn1SccMyGyroVal_REQUIRED_BYTES_FOR_ACN_ENCODING   13 
#define asn1SccMyGyroVal_REQUIRED_BITS_FOR_ACN_ENCODING    104
#define asn1SccMyGyroVal_REQUIRED_BYTES_FOR_XER_ENCODING   73

void asn1SccMyGyroVal_Initialize(asn1SccMyGyroVal* pVal);
flag asn1SccMyGyroVal_IsConstraintValid(const asn1SccMyGyroVal* val, int* pErrCode);
#ifndef ERR_asn1SccMyGyroVal 
#define ERR_asn1SccMyGyroVal		1006  /*(-1.00000000000000000000E+005 .. 1.00000000000000000000E+005)*/
#endif

typedef double asn1SccMyAccVal;

#define asn1SccMyAccVal_REQUIRED_BYTES_FOR_ENCODING       13 
#define asn1SccMyAccVal_REQUIRED_BITS_FOR_ENCODING        104
#define asn1SccMyAccVal_REQUIRED_BYTES_FOR_ACN_ENCODING   13 
#define asn1SccMyAccVal_REQUIRED_BITS_FOR_ACN_ENCODING    104
#define asn1SccMyAccVal_REQUIRED_BYTES_FOR_XER_ENCODING   71

void asn1SccMyAccVal_Initialize(asn1SccMyAccVal* pVal);
flag asn1SccMyAccVal_IsConstraintValid(const asn1SccMyAccVal* val, int* pErrCode);
#ifndef ERR_asn1SccMyAccVal 
#define ERR_asn1SccMyAccVal		1007  /*(-1.60000000000000000000E+001 .. 1.60000000000000000000E+001)*/
#endif
...
#define ERR_asn1SccMySeq_validity_unknown_enumeration_value		1009  /**/
#endif
#ifndef ERR_asn1SccMySeq_validity 
#define ERR_asn1SccMySeq_validity		1008  /**/
#endif
...
#define ERR_asn1SccMyChoice_unknown_choice_index		1014  /**/
#endif
...
flag asn1SccMyGyroVal_Encode(const asn1SccMyGyroVal* val, BitStream* pBitStrm, int* pErrCode, flag bCheckConstraints);
flag asn1SccMyGyroVal_Decode(asn1SccMyGyroVal* pVal, BitStream* pBitStrm, int* pErrCode);
flag asn1SccMyAccVal_Encode(const asn1SccMyAccVal* val, BitStream* pBitStrm, int* pErrCode, flag bCheckConstraints);
flag asn1SccMyAccVal_Decode(asn1SccMyAccVal* pVal, BitStream* pBitStrm, int* pErrCode);
