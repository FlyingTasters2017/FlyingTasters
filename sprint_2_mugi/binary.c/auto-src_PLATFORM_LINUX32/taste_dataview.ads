...
asn1SccMyPWM_REQUIRED_BYTES_FOR_ENCODING:CONSTANT INTEGER := 52;
asn1SccMyPWM_REQUIRED_BITS_FOR_ENCODING:CONSTANT INTEGER := 416;
asn1SccMyPWM_REQUIRED_BYTES_FOR_ACN_ENCODING:CONSTANT INTEGER := 52;
asn1SccMyPWM_REQUIRED_BITS_FOR_ACN_ENCODING:CONSTANT INTEGER := 416;
asn1SccMyPWM_REQUIRED_BYTES_FOR_XER_ENCODING:CONSTANT INTEGER :=  0;
...
FUNCTION "=" (val1, val2: in asn1SccMyPWM) return Boolean renames asn1SccMyPWM_Equal;


-----------------------------------------------------------asn1SccMyTrajectory-------------------------------------------------------------
TYPE asn1SccMyTrajectory IS RECORD 
    x : asn1SccMyReal;
    y : asn1SccMyReal;
    z : asn1SccMyReal;
    yaw : asn1SccMyReal;
...
asn1SccMyTrajectory_REQUIRED_BYTES_FOR_ENCODING:CONSTANT INTEGER := 52;
asn1SccMyTrajectory_REQUIRED_BITS_FOR_ENCODING:CONSTANT INTEGER := 416;
asn1SccMyTrajectory_REQUIRED_BYTES_FOR_ACN_ENCODING:CONSTANT INTEGER := 52;
asn1SccMyTrajectory_REQUIRED_BITS_FOR_ACN_ENCODING:CONSTANT INTEGER := 416;
asn1SccMyTrajectory_REQUIRED_BYTES_FOR_XER_ENCODING:CONSTANT INTEGER :=  0;
...
FUNCTION "=" (val1, val2: in asn1SccMyTrajectory) return Boolean renames asn1SccMyTrajectory_Equal;


-----------------------------------------------------------asn1SccMyStates-------------------------------------------------------------
TYPE asn1SccMyStates IS RECORD 
    x : asn1SccMyReal;
    y : asn1SccMyReal;
    z : asn1SccMyReal;
    yaw : asn1SccMyReal;
    ...
    dz : asn1SccMyReal;
    dyaw : asn1SccMyReal;
    dpitch : asn1SccMyReal;
    droll : asn1SccMyReal;
END RECORD;

asn1SccMyStates_REQUIRED_BYTES_FOR_ENCODING:CONSTANT INTEGER := 156;
asn1SccMyStates_REQUIRED_BITS_FOR_ENCODING:CONSTANT INTEGER := 1248;
asn1SccMyStates_REQUIRED_BYTES_FOR_ACN_ENCODING:CONSTANT INTEGER := 156;
asn1SccMyStates_REQUIRED_BITS_FOR_ACN_ENCODING:CONSTANT INTEGER := 1248;
asn1SccMyStates_REQUIRED_BYTES_FOR_XER_ENCODING:CONSTANT INTEGER :=  0;
...
FUNCTION "=" (val1, val2: in asn1SccMyStates) return Boolean renames asn1SccMyStates_Equal;
