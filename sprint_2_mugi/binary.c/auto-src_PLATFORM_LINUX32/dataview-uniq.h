...
#define asn1SccMyPWM_REQUIRED_BYTES_FOR_ENCODING       52 
#define asn1SccMyPWM_REQUIRED_BITS_FOR_ENCODING        416
#define asn1SccMyPWM_REQUIRED_BYTES_FOR_ACN_ENCODING   52 
#define asn1SccMyPWM_REQUIRED_BITS_FOR_ACN_ENCODING    416
#define asn1SccMyPWM_REQUIRED_BYTES_FOR_XER_ENCODING   267

void asn1SccMyPWM_Initialize(asn1SccMyPWM* pVal);
flag asn1SccMyPWM_IsConstraintValid(const asn1SccMyPWM* val, int* pErrCode);
...
#define asn1SccMyTrajectory_REQUIRED_BYTES_FOR_ENCODING       52 
#define asn1SccMyTrajectory_REQUIRED_BITS_FOR_ENCODING        416
#define asn1SccMyTrajectory_REQUIRED_BYTES_FOR_ACN_ENCODING   52 
#define asn1SccMyTrajectory_REQUIRED_BITS_FOR_ACN_ENCODING    416
#define asn1SccMyTrajectory_REQUIRED_BYTES_FOR_XER_ENCODING   261

void asn1SccMyTrajectory_Initialize(asn1SccMyTrajectory* pVal);
flag asn1SccMyTrajectory_IsConstraintValid(const asn1SccMyTrajectory* val, int* pErrCode);
...
typedef struct {
    ...
    asn1SccMyReal dz;
    asn1SccMyReal dyaw;
    asn1SccMyReal dpitch;
    asn1SccMyReal droll;
} asn1SccMyStates;

#define asn1SccMyStates_REQUIRED_BYTES_FOR_ENCODING       156 
#define asn1SccMyStates_REQUIRED_BITS_FOR_ENCODING        1248
#define asn1SccMyStates_REQUIRED_BYTES_FOR_ACN_ENCODING   156 
#define asn1SccMyStates_REQUIRED_BITS_FOR_ACN_ENCODING    1248
#define asn1SccMyStates_REQUIRED_BYTES_FOR_XER_ENCODING   753

void asn1SccMyStates_Initialize(asn1SccMyStates* pVal);
flag asn1SccMyStates_IsConstraintValid(const asn1SccMyStates* val, int* pErrCode);
...
flag asn1SccMyPWM_Encode(const asn1SccMyPWM* val, BitStream* pBitStrm, int* pErrCode, flag bCheckConstraints);
flag asn1SccMyPWM_Decode(asn1SccMyPWM* pVal, BitStream* pBitStrm, int* pErrCode);
flag asn1SccMyPWM_ACN_Encode(const asn1SccMyPWM* val, BitStream* pBitStrm, int* pErrCode, flag bCheckConstraints);
flag asn1SccMyPWM_ACN_Decode(asn1SccMyPWM* pVal, BitStream* pBitStrm, int* pErrCode);
flag asn1SccMyTrajectory_Encode(const asn1SccMyTrajectory* val, BitStream* pBitStrm, int* pErrCode, flag bCheckConstraints);
flag asn1SccMyTrajectory_Decode(asn1SccMyTrajectory* pVal, BitStream* pBitStrm, int* pErrCode);
flag asn1SccMyTrajectory_ACN_Encode(const asn1SccMyTrajectory* val, BitStream* pBitStrm, int* pErrCode, flag bCheckConstraints);
flag asn1SccMyTrajectory_ACN_Decode(asn1SccMyTrajectory* pVal, BitStream* pBitStrm, int* pErrCode);
flag asn1SccMyStates_Encode(const asn1SccMyStates* val, BitStream* pBitStrm, int* pErrCode, flag bCheckConstraints);
flag asn1SccMyStates_Decode(asn1SccMyStates* pVal, BitStream* pBitStrm, int* pErrCode);
flag asn1SccMyStates_ACN_Encode(const asn1SccMyStates* val, BitStream* pBitStrm, int* pErrCode, flag bCheckConstraints);
...
flag asn1SccMyBool_ACN_Encode(const asn1SccMyBool* val, BitStream* pBitStrm, int* pErrCode, flag bCheckConstraints);
...
flag asn1SccMyEnum_ACN_Encode(const asn1SccMyEnum* val, BitStream* pBitStrm, int* pErrCode, flag bCheckConstraints);
...
flag asn1SccMySeqOf_ACN_Encode(const asn1SccMySeqOf* val, BitStream* pBitStrm, int* pErrCode, flag bCheckConstraints);
...
flag asn1SccMyOctStr_ACN_Encode(const asn1SccMyOctStr* val, BitStream* pBitStrm, int* pErrCode, flag bCheckConstraints);
...
flag asn1SccMySeq_validity_ACN_Encode(const asn1SccMySeq_validity* val, BitStream* pBitStrm, int* pErrCode, flag bCheckConstraints);
...
flag asn1SccMySeq_ACN_Encode(const asn1SccMySeq* val, BitStream* pBitStrm, int* pErrCode, flag bCheckConstraints);
...
flag asn1SccMyChoice_ACN_Encode(const asn1SccMyChoice* val, BitStream* pBitStrm, int* pErrCode, flag bCheckConstraints);
