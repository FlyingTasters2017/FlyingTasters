...
------------------------------------------------------ */
void vm_async_vt_ground_gui_polling_ground_Takeoff_vt(void *Trajectory, size_t Trajectory_len)
{
	__po_hi_request_t request;

	__po_hi_copy_array(&(request.vars.vt_ground_gui_polling_ground_global_outport_takeoff_vt.vt_ground_gui_polling_ground_global_outport_takeoff_vt.buffer), Trajectory, Trajectory_len);
	request.vars.vt_ground_gui_polling_ground_global_outport_takeoff_vt.vt_ground_gui_polling_ground_global_outport_takeoff_vt.length = Trajectory_len;
