...
void PrintASN1MyPWM(const char *paramName, const asn1SccMyPWM *pData)
{
#ifdef __linux__
    pthread_mutex_lock(&g_printing_mutex);
#endif
#ifdef __unix__
    //printf("%s MyPWM ::= ", paramName);
    printf("%s ", paramName);
    printf("{");
    printf("pwm1 ");
    printf("%f", (*pData).pwm1);
...
void PrintASN1MyTrajectory(const char *paramName, const asn1SccMyTrajectory *pData)
{
#ifdef __linux__
    pthread_mutex_lock(&g_printing_mutex);
#endif
#ifdef __unix__
    //printf("%s MyTrajectory ::= ", paramName);
    printf("%s ", paramName);
    printf("{");
    printf("x ");
    printf("%f", (*pData).x);
...
void PrintASN1MyStates(const char *paramName, const asn1SccMyStates *pData)
{
#ifdef __linux__
    pthread_mutex_lock(&g_printing_mutex);
#endif
#ifdef __unix__
    //printf("%s MyStates ::= ", paramName);
    printf("%s ", paramName);
    printf("{");
    printf("x ");
    printf("%f", (*pData).x);
    ...
    printf(", ");
    printf("dpitch ");
    printf("%f", (*pData).dpitch);
    printf(", ");
    printf("droll ");
    printf("%f", (*pData).droll);
    printf("}");
#endif
#ifdef __linux__
    pthread_mutex_unlock(&g_printing_mutex);
