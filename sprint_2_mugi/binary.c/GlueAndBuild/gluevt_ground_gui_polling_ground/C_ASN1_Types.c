...
#ifdef __NEED_MyTrajectory_UPER
size_t Encode_UPER_MyTrajectory(void *pBuffer, size_t iMaxBufferSize, const asn1SccMyTrajectory *pSrc)
{
    int errorCode;
    STATIC BitStream strm;

    BitStream_Init(&strm, pBuffer, iMaxBufferSize);
    if (asn1SccMyTrajectory_Encode(pSrc, &strm, &errorCode, TRUE) == FALSE) {
#ifdef __unix__
	fprintf(stderr, "Could not encode MyTrajectory (at %s, %d), errorCode was %d\n", __FILE__, __LINE__, errorCode);
#endif
        return -1;
    } else {
...
#ifdef __NEED_MyTrajectory_ACN
size_t Encode_ACN_MyTrajectory(void *pBuffer, size_t iMaxBufferSize, asn1SccMyTrajectory *pSrc)
{
    int errorCode;
    STATIC BitStream strm;

    BitStream_Init(&strm, pBuffer, iMaxBufferSize);
    if (asn1SccMyTrajectory_ACN_Encode(pSrc, &strm, &errorCode, TRUE) == FALSE) {
#ifdef __unix__
	fprintf(stderr, "Could not encode MyTrajectory (at %s, %d), errorCode was %d\n", __FILE__, __LINE__, errorCode);
#endif
        return -1;
...
#ifdef __NEED_MyTrajectory_NATIVE
size_t Encode_NATIVE_MyTrajectory(void *pBuffer, size_t iMaxBufferSize, const asn1SccMyTrajectory *pSrc)
{
    memcpy(pBuffer, pSrc, sizeof(asn1SccMyTrajectory) );
    return sizeof(asn1SccMyTrajectory);
}
#endif

#ifdef __NEED_MyTrajectory_UPER
int Decode_UPER_MyTrajectory(asn1SccMyTrajectory *pDst, void *pBuffer, size_t iBufferSize)
{
    int errorCode;
    ...
    if (asn1SccMyTrajectory_Decode(pDst, &strm, &errorCode)) {
        /* Decoding succeeded */
        return 0;
    } else {
#ifdef __unix__
	fprintf(stderr, "Could not decode MyTrajectory (at %s, %d), error code was %d\n", __FILE__, __LINE__, errorCode);
#endif
        return -1;
    }
}
...
#ifdef __NEED_MyTrajectory_ACN
int Decode_ACN_MyTrajectory(asn1SccMyTrajectory *pDst, void *pBuffer, size_t iBufferSize)
{
    int errorCode;
    ...
    if (asn1SccMyTrajectory_ACN_Decode(pDst, &strm, &errorCode)) {
        /* Decoding succeeded */
        return 0;
    } else {
#ifdef __unix__
...
#ifdef __NEED_MyTrajectory_NATIVE
int Decode_NATIVE_MyTrajectory(asn1SccMyTrajectory *pDst, void *pBuffer, size_t iBufferSize)
{
    *pDst = *(asn1SccMyTrajectory *) pBuffer;
    {
        return 0;
    }
}
...
#ifdef __NEED_MyPWM_UPER
size_t Encode_UPER_MyPWM(void *pBuffer, size_t iMaxBufferSize, const asn1SccMyPWM *pSrc)
{
    int errorCode;
    STATIC BitStream strm;

    BitStream_Init(&strm, pBuffer, iMaxBufferSize);
    if (asn1SccMyPWM_Encode(pSrc, &strm, &errorCode, TRUE) == FALSE) {
#ifdef __unix__
	fprintf(stderr, "Could not encode MyPWM (at %s, %d), errorCode was %d\n", __FILE__, __LINE__, errorCode);
#endif
        return -1;
    } else {
        return BitStream_GetLength(&strm);
...
#ifdef __NEED_MyPWM_ACN
size_t Encode_ACN_MyPWM(void *pBuffer, size_t iMaxBufferSize, asn1SccMyPWM *pSrc)
{
    int errorCode;
    STATIC BitStream strm;

    BitStream_Init(&strm, pBuffer, iMaxBufferSize);
    if (asn1SccMyPWM_ACN_Encode(pSrc, &strm, &errorCode, TRUE) == FALSE) {
#ifdef __unix__
	fprintf(stderr, "Could not encode MyPWM (at %s, %d), errorCode was %d\n", __FILE__, __LINE__, errorCode);
#endif
        return -1;
...
#ifdef __NEED_MyPWM_NATIVE
size_t Encode_NATIVE_MyPWM(void *pBuffer, size_t iMaxBufferSize, const asn1SccMyPWM *pSrc)
{
    memcpy(pBuffer, pSrc, sizeof(asn1SccMyPWM) );
    return sizeof(asn1SccMyPWM);
}
#endif

#ifdef __NEED_MyPWM_UPER
int Decode_UPER_MyPWM(asn1SccMyPWM *pDst, void *pBuffer, size_t iBufferSize)
{
    int errorCode;
    ...
    if (asn1SccMyPWM_Decode(pDst, &strm, &errorCode)) {
        /* Decoding succeeded */
        return 0;
    } else {
#ifdef __unix__
	fprintf(stderr, "Could not decode MyPWM (at %s, %d), error code was %d\n", __FILE__, __LINE__, errorCode);
#endif
        return -1;
    }
}
...
#ifdef __NEED_MyPWM_ACN
int Decode_ACN_MyPWM(asn1SccMyPWM *pDst, void *pBuffer, size_t iBufferSize)
{
    int errorCode;
    ...
    if (asn1SccMyPWM_ACN_Decode(pDst, &strm, &errorCode)) {
        /* Decoding succeeded */
        return 0;
    } else {
#ifdef __unix__
...
#ifdef __NEED_MyPWM_NATIVE
int Decode_NATIVE_MyPWM(asn1SccMyPWM *pDst, void *pBuffer, size_t iBufferSize)
{
    *pDst = *(asn1SccMyPWM *) pBuffer;
    {
        return 0;
    }
}
...
#ifdef __NEED_MyStates_UPER
size_t Encode_UPER_MyStates(void *pBuffer, size_t iMaxBufferSize, const asn1SccMyStates *pSrc)
{
    int errorCode;
    STATIC BitStream strm;

    BitStream_Init(&strm, pBuffer, iMaxBufferSize);
    if (asn1SccMyStates_Encode(pSrc, &strm, &errorCode, TRUE) == FALSE) {
#ifdef __unix__
	fprintf(stderr, "Could not encode MyStates (at %s, %d), errorCode was %d\n", __FILE__, __LINE__, errorCode);
#endif
        return -1;
    } else {
        return BitStream_GetLength(&strm);
...
#ifdef __NEED_MyStates_ACN
size_t Encode_ACN_MyStates(void *pBuffer, size_t iMaxBufferSize, asn1SccMyStates *pSrc)
{
    int errorCode;
    STATIC BitStream strm;

    BitStream_Init(&strm, pBuffer, iMaxBufferSize);
    if (asn1SccMyStates_ACN_Encode(pSrc, &strm, &errorCode, TRUE) == FALSE) {
#ifdef __unix__
	fprintf(stderr, "Could not encode MyStates (at %s, %d), errorCode was %d\n", __FILE__, __LINE__, errorCode);
#endif
        return -1;
...
#ifdef __NEED_MyStates_NATIVE
size_t Encode_NATIVE_MyStates(void *pBuffer, size_t iMaxBufferSize, const asn1SccMyStates *pSrc)
{
    memcpy(pBuffer, pSrc, sizeof(asn1SccMyStates) );
    return sizeof(asn1SccMyStates);
}
#endif

#ifdef __NEED_MyStates_UPER
int Decode_UPER_MyStates(asn1SccMyStates *pDst, void *pBuffer, size_t iBufferSize)
{
    int errorCode;
    ...
    if (asn1SccMyStates_Decode(pDst, &strm, &errorCode)) {
        /* Decoding succeeded */
        return 0;
    } else {
#ifdef __unix__
	fprintf(stderr, "Could not decode MyStates (at %s, %d), error code was %d\n", __FILE__, __LINE__, errorCode);
#endif
        return -1;
    }
}
...
#ifdef __NEED_MyStates_ACN
int Decode_ACN_MyStates(asn1SccMyStates *pDst, void *pBuffer, size_t iBufferSize)
{
    int errorCode;
    ...
    if (asn1SccMyStates_ACN_Decode(pDst, &strm, &errorCode)) {
        /* Decoding succeeded */
        return 0;
    } else {
#ifdef __unix__
...
#ifdef __NEED_MyStates_NATIVE
int Decode_NATIVE_MyStates(asn1SccMyStates *pDst, void *pBuffer, size_t iBufferSize)
{
    *pDst = *(asn1SccMyStates *) pBuffer;
    {
        return 0;
    }
}
