...
typedef struct
{
  ...
  union
  {
    struct
    {
      dataview__mytrajectory_buffer_impl vt_obsw_takeoff_global_inport_artificial_takeoff;
    ...
    struct
    {
      dataview__mytrajectory_buffer_impl vt_ground_getheight_global_outport_takeoff_vt;

    } vt_ground_getheight_global_outport_takeoff_vt;

    struct
    {
      dataview__mytrajectory_buffer_impl vt_ground_gui_polling_ground_global_outport_takeoff_vt;
