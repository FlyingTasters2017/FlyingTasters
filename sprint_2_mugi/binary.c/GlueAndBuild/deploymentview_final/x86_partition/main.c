 ...
 */
  __po_hi_create_periodic_task (x86_partition_vt_obsw_pulse_k, &(period), 1, 50000, 0, vt_obsw_pulse_job);
  
/*!
 * Store the period time for task vt_ground_getheight
 */
  __po_hi_milliseconds (&(period), 1);
 ...
 * Making Sporadic task
 */
  __po_hi_create_sporadic_task (x86_partition_vt_ground_getheight_k, &(period), 1, 50000, 0, vt_ground_getheight_job);
