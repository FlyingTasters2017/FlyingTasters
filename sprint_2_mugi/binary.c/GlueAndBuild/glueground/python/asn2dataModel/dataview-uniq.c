...
#if !defined(_MSC_VER) || _MSC_VER >= 1800
void MyPWM_Initialize(MyPWM* pVal)
{
    *pVal = (MyPWM) {
...
flag MyPWM_IsConstraintValid(const MyPWM* pVal, int* pErrCode)
{
	...
	*pErrCode=0;
	...
	ret = MyReal_IsConstraintValid(&pVal->pwm1, pErrCode);
	if (ret) {
	    ret = MyReal_IsConstraintValid(&pVal->pwm2, pErrCode);
	    if (ret) {
	        ret = MyReal_IsConstraintValid(&pVal->pwm3, pErrCode);
	        if (ret) {
	            ret = MyReal_IsConstraintValid(&pVal->pwm4, pErrCode);
...
flag MyPWM_Equal(const MyPWM* pVal1, const MyPWM* pVal2)
{
	flag ret=TRUE;
	
	ret = MyReal_Equal(&pVal1->pwm1, &pVal2->pwm1);
	if (ret) {
	    ret = MyReal_Equal(&pVal1->pwm2, &pVal2->pwm2);
	    if (ret) {
	        ret = MyReal_Equal(&pVal1->pwm3, &pVal2->pwm3);
	        if (ret) {
	            ret = MyReal_Equal(&pVal1->pwm4, &pVal2->pwm4);
...
flag MyPWM_Encode(const MyPWM* pVal, BitStream* pBitStrm, int* pErrCode, flag bCheckConstraints)
{
    flag ret = TRUE;
    
	ret = bCheckConstraints ? MyPWM_IsConstraintValid(pVal, pErrCode) : TRUE ;
	if (ret) {
	    /*Encode pwm1 */
	    ret = MyReal_Encode(&pVal->pwm1, pBitStrm, pErrCode, FALSE);
	    if (ret) {
	        /*Encode pwm2 */
	        ret = MyReal_Encode(&pVal->pwm2, pBitStrm, pErrCode, FALSE);
	        if (ret) {
	            /*Encode pwm3 */
	            ret = MyReal_Encode(&pVal->pwm3, pBitStrm, pErrCode, FALSE);
	            if (ret) {
	                /*Encode pwm4 */
	                ret = MyReal_Encode(&pVal->pwm4, pBitStrm, pErrCode, FALSE);
...
flag MyPWM_Decode(MyPWM* pVal, BitStream* pBitStrm, int* pErrCode)
{
    flag ret = TRUE;

	/*Decode pwm1 */
	ret = MyReal_Decode(&pVal->pwm1, pBitStrm, pErrCode);
	if (ret) {
	    /*Decode pwm2 */
	    ret = MyReal_Decode(&pVal->pwm2, pBitStrm, pErrCode);
	    if (ret) {
	        /*Decode pwm3 */
	        ret = MyReal_Decode(&pVal->pwm3, pBitStrm, pErrCode);
	        if (ret) {
	            /*Decode pwm4 */
	            ret = MyReal_Decode(&pVal->pwm4, pBitStrm, pErrCode);
...
flag MyPWM_ACN_Encode(const MyPWM* pVal, BitStream* pBitStrm, int* pErrCode, flag bCheckConstraints)
{
    flag ret = TRUE;
	...
	if (ret) {
	    /*Encode pwm1 */
	    ret = MyReal_ACN_Encode(&pVal->pwm1, pBitStrm, pErrCode, FALSE);
	    if (ret) {
	        /*Encode pwm2 */
	        ret = MyReal_ACN_Encode(&pVal->pwm2, pBitStrm, pErrCode, FALSE);
	        if (ret) {
	            /*Encode pwm3 */
	            ret = MyReal_ACN_Encode(&pVal->pwm3, pBitStrm, pErrCode, FALSE);
	            if (ret) {
	                /*Encode pwm4 */
	                ret = MyReal_ACN_Encode(&pVal->pwm4, pBitStrm, pErrCode, FALSE);
...
flag MyPWM_ACN_Decode(MyPWM* pVal, BitStream* pBitStrm, int* pErrCode)
{
    flag ret = TRUE;
    *pErrCode = 0;
    /*Decode pwm1 */
    ret = MyReal_ACN_Decode(&pVal->pwm1, pBitStrm, pErrCode);
    if (ret) {
        /*Decode pwm2 */
        ret = MyReal_ACN_Decode(&pVal->pwm2, pBitStrm, pErrCode);
        if (ret) {
            /*Decode pwm3 */
            ret = MyReal_ACN_Decode(&pVal->pwm3, pBitStrm, pErrCode);
            if (ret) {
                /*Decode pwm4 */
                ret = MyReal_ACN_Decode(&pVal->pwm4, pBitStrm, pErrCode);
...
#if !defined(_MSC_VER) || _MSC_VER >= 1800
void MyTrajectory_Initialize(MyTrajectory* pVal)
{
    *pVal = (MyTrajectory) {
...
flag MyTrajectory_IsConstraintValid(const MyTrajectory* pVal, int* pErrCode)
{
...
flag MyTrajectory_Equal(const MyTrajectory* pVal1, const MyTrajectory* pVal2)
{
	flag ret=TRUE;
...
flag MyTrajectory_Encode(const MyTrajectory* pVal, BitStream* pBitStrm, int* pErrCode, flag bCheckConstraints)
{
    flag ret = TRUE;
    
	ret = bCheckConstraints ? MyTrajectory_IsConstraintValid(pVal, pErrCode) : TRUE ;
	if (ret) {
	    /*Encode x */
...
flag MyTrajectory_Decode(MyTrajectory* pVal, BitStream* pBitStrm, int* pErrCode)
{
    flag ret = TRUE;
...
flag MyTrajectory_ACN_Encode(const MyTrajectory* pVal, BitStream* pBitStrm, int* pErrCode, flag bCheckConstraints)
{
    flag ret = TRUE;
...
flag MyTrajectory_ACN_Decode(MyTrajectory* pVal, BitStream* pBitStrm, int* pErrCode)
{
    flag ret = TRUE;
    *pErrCode = 0;
    /*Decode x */
...
#if !defined(_MSC_VER) || _MSC_VER >= 1800
void MyStates_Initialize(MyStates* pVal)
{
    *pVal = (MyStates) {
    .x = 0.00000000000000000000E+000,
    .y = 0.00000000000000000000E+000,
...
flag MyStates_IsConstraintValid(const MyStates* pVal, int* pErrCode)
{
	        ...
	        if (ret) {
	            ...
	            if (ret) {
	                ...
	                if (ret) {
	                    ...
	                    if (ret) {
	                        ret = MyReal_IsConstraintValid(&pVal->dx, pErrCode);
	                        if (ret) {
	                            ret = MyReal_IsConstraintValid(&pVal->dy, pErrCode);
	                            if (ret) {
	                                ret = MyReal_IsConstraintValid(&pVal->dz, pErrCode);
	                                if (ret) {
	                                    ret = MyReal_IsConstraintValid(&pVal->dyaw, pErrCode);
	                                    if (ret) {
	                                        ret = MyReal_IsConstraintValid(&pVal->dpitch, pErrCode);
	                                        if (ret) {
	                                            ret = MyReal_IsConstraintValid(&pVal->droll, pErrCode);
...
flag MyStates_Equal(const MyStates* pVal1, const MyStates* pVal2)
{
	flag ret=TRUE;
	        ...
	        if (ret) {
	            ...
	            if (ret) {
	                ...
	                if (ret) {
	                    ...
	                    if (ret) {
	                        ret = MyReal_Equal(&pVal1->dx, &pVal2->dx);
	                        if (ret) {
	                            ret = MyReal_Equal(&pVal1->dy, &pVal2->dy);
	                            if (ret) {
	                                ret = MyReal_Equal(&pVal1->dz, &pVal2->dz);
	                                if (ret) {
	                                    ret = MyReal_Equal(&pVal1->dyaw, &pVal2->dyaw);
	                                    if (ret) {
	                                        ret = MyReal_Equal(&pVal1->dpitch, &pVal2->dpitch);
	                                        if (ret) {
	                                            ret = MyReal_Equal(&pVal1->droll, &pVal2->droll);
...
flag MyStates_Encode(const MyStates* pVal, BitStream* pBitStrm, int* pErrCode, flag bCheckConstraints)
{
    flag ret = TRUE;
    
	ret = bCheckConstraints ? MyStates_IsConstraintValid(pVal, pErrCode) : TRUE ;
	if (ret) {
	    /*Encode x */
	    ret = MyReal_Encode(&pVal->x, pBitStrm, pErrCode, FALSE);
	    if (ret) {
	            ...
	            if (ret) {
	                ...
	                if (ret) {
	                    ...
	                    if (ret) {
	                        ...
	                        if (ret) {
	                            /*Encode dx */
	                            ret = MyReal_Encode(&pVal->dx, pBitStrm, pErrCode, FALSE);
	                            if (ret) {
	                                /*Encode dy */
	                                ret = MyReal_Encode(&pVal->dy, pBitStrm, pErrCode, FALSE);
	                                if (ret) {
	                                    /*Encode dz */
	                                    ret = MyReal_Encode(&pVal->dz, pBitStrm, pErrCode, FALSE);
	                                    if (ret) {
	                                        /*Encode dyaw */
	                                        ret = MyReal_Encode(&pVal->dyaw, pBitStrm, pErrCode, FALSE);
	                                        if (ret) {
	                                            /*Encode dpitch */
	                                            ret = MyReal_Encode(&pVal->dpitch, pBitStrm, pErrCode, FALSE);
	                                            if (ret) {
	                                                /*Encode droll */
	                                                ret = MyReal_Encode(&pVal->droll, pBitStrm, pErrCode, FALSE);
...
flag MyStates_Decode(MyStates* pVal, BitStream* pBitStrm, int* pErrCode)
{
    flag ret = TRUE;
	        ...
	        if (ret) {
	            ...
	            if (ret) {
	                ...
	                if (ret) {
	                    ...
	                    if (ret) {
	                        /*Decode dx */
	                        ret = MyReal_Decode(&pVal->dx, pBitStrm, pErrCode);
	                        if (ret) {
	                            /*Decode dy */
	                            ret = MyReal_Decode(&pVal->dy, pBitStrm, pErrCode);
	                            if (ret) {
	                                /*Decode dz */
	                                ret = MyReal_Decode(&pVal->dz, pBitStrm, pErrCode);
	                                if (ret) {
	                                    /*Decode dyaw */
	                                    ret = MyReal_Decode(&pVal->dyaw, pBitStrm, pErrCode);
	                                    if (ret) {
	                                        /*Decode dpitch */
	                                        ret = MyReal_Decode(&pVal->dpitch, pBitStrm, pErrCode);
	                                        if (ret) {
	                                            /*Decode droll */
	                                            ret = MyReal_Decode(&pVal->droll, pBitStrm, pErrCode);
...
flag MyStates_ACN_Encode(const MyStates* pVal, BitStream* pBitStrm, int* pErrCode, flag bCheckConstraints)
{
    flag ret = TRUE;
	            ...
	            if (ret) {
	                ...
	                if (ret) {
	                    ...
	                    if (ret) {
	                        ...
	                        if (ret) {
	                            /*Encode dx */
	                            ret = MyReal_ACN_Encode(&pVal->dx, pBitStrm, pErrCode, FALSE);
	                            if (ret) {
	                                /*Encode dy */
	                                ret = MyReal_ACN_Encode(&pVal->dy, pBitStrm, pErrCode, FALSE);
	                                if (ret) {
	                                    /*Encode dz */
	                                    ret = MyReal_ACN_Encode(&pVal->dz, pBitStrm, pErrCode, FALSE);
	                                    if (ret) {
	                                        /*Encode dyaw */
	                                        ret = MyReal_ACN_Encode(&pVal->dyaw, pBitStrm, pErrCode, FALSE);
	                                        if (ret) {
	                                            /*Encode dpitch */
	                                            ret = MyReal_ACN_Encode(&pVal->dpitch, pBitStrm, pErrCode, FALSE);
	                                            if (ret) {
	                                                /*Encode droll */
	                                                ret = MyReal_ACN_Encode(&pVal->droll, pBitStrm, pErrCode, FALSE);
...
flag MyStates_ACN_Decode(MyStates* pVal, BitStream* pBitStrm, int* pErrCode)
{
    flag ret = TRUE;
    *pErrCode = 0;
    /*Decode x */
            ...
            if (ret) {
                ...
                if (ret) {
                    ...
                    if (ret) {
                        ...
                        if (ret) {
                            /*Decode dx */
                            ret = MyReal_ACN_Decode(&pVal->dx, pBitStrm, pErrCode);
                            if (ret) {
                                /*Decode dy */
                                ret = MyReal_ACN_Decode(&pVal->dy, pBitStrm, pErrCode);
                                if (ret) {
                                    /*Decode dz */
                                    ret = MyReal_ACN_Decode(&pVal->dz, pBitStrm, pErrCode);
                                    if (ret) {
                                        /*Decode dyaw */
                                        ret = MyReal_ACN_Decode(&pVal->dyaw, pBitStrm, pErrCode);
                                        if (ret) {
                                            /*Decode dpitch */
                                            ret = MyReal_ACN_Decode(&pVal->dpitch, pBitStrm, pErrCode);
                                            if (ret) {
                                                /*Decode droll */
                                                ret = MyReal_ACN_Decode(&pVal->droll, pBitStrm, pErrCode);
