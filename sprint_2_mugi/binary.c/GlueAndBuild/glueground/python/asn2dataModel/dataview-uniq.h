...
#ifndef ERR_MyReal 
#define ERR_MyReal		1001  /*(0.00000000000000000000E+000 .. 1.00000000000000000000E+003)*/
#endif
...
#define MyPWM_REQUIRED_BYTES_FOR_ENCODING       52 
#define MyPWM_REQUIRED_BITS_FOR_ENCODING        416
#define MyPWM_REQUIRED_BYTES_FOR_ACN_ENCODING   52 
#define MyPWM_REQUIRED_BITS_FOR_ACN_ENCODING    416
#define MyPWM_REQUIRED_BYTES_FOR_XER_ENCODING   267

void MyPWM_Initialize(MyPWM* pVal);
flag MyPWM_IsConstraintValid(const MyPWM* val, int* pErrCode);
flag MyPWM_Equal(const MyPWM* val1, const MyPWM* val2);
...
#define MyTrajectory_REQUIRED_BYTES_FOR_ENCODING       52 
#define MyTrajectory_REQUIRED_BITS_FOR_ENCODING        416
#define MyTrajectory_REQUIRED_BYTES_FOR_ACN_ENCODING   52 
#define MyTrajectory_REQUIRED_BITS_FOR_ACN_ENCODING    416
#define MyTrajectory_REQUIRED_BYTES_FOR_XER_ENCODING   261

void MyTrajectory_Initialize(MyTrajectory* pVal);
flag MyTrajectory_IsConstraintValid(const MyTrajectory* val, int* pErrCode);
flag MyTrajectory_Equal(const MyTrajectory* val1, const MyTrajectory* val2);
...
#define MyStates_REQUIRED_BYTES_FOR_ENCODING       156 
#define MyStates_REQUIRED_BITS_FOR_ENCODING        1248
#define MyStates_REQUIRED_BYTES_FOR_ACN_ENCODING   156 
#define MyStates_REQUIRED_BITS_FOR_ACN_ENCODING    1248
#define MyStates_REQUIRED_BYTES_FOR_XER_ENCODING   753

void MyStates_Initialize(MyStates* pVal);
flag MyStates_IsConstraintValid(const MyStates* val, int* pErrCode);
flag MyStates_Equal(const MyStates* val1, const MyStates* val2);
...
#define ERR_MyEnum_unknown_enumeration_value		1003  /**/
#endif
#ifndef ERR_MyEnum 
#define ERR_MyEnum		1002  /**/
#endif
...
#ifndef ERR_MySeqOf 
#define ERR_MySeqOf		1004  /*(SIZE(2))*/
#endif
...
#ifndef ERR_MyOctStr 
#define ERR_MyOctStr		1005  /*(SIZE(3))*/
#endif
...
#define ERR_MySeq_validity_unknown_enumeration_value		1007  /**/
#endif
#ifndef ERR_MySeq_validity 
#define ERR_MySeq_validity		1006  /**/
#endif
...
#ifndef ERR_T_Int32 
#define ERR_T_Int32		1008  /*(-2147483648 .. 2147483647)*/
#endif
...
#ifndef ERR_T_UInt32 
#define ERR_T_UInt32		1009  /*(0 .. 4294967295)*/
#endif
...
#ifndef ERR_T_Int8 
#define ERR_T_Int8		1010  /*(-128 .. 127)*/
#endif
...
flag MyPWM_Encode(const MyPWM* val, BitStream* pBitStrm, int* pErrCode, flag bCheckConstraints);
flag MyPWM_Decode(MyPWM* pVal, BitStream* pBitStrm, int* pErrCode);
flag MyPWM_ACN_Encode(const MyPWM* val, BitStream* pBitStrm, int* pErrCode, flag bCheckConstraints);
flag MyPWM_ACN_Decode(MyPWM* pVal, BitStream* pBitStrm, int* pErrCode);
flag MyTrajectory_Encode(const MyTrajectory* val, BitStream* pBitStrm, int* pErrCode, flag bCheckConstraints);
flag MyTrajectory_Decode(MyTrajectory* pVal, BitStream* pBitStrm, int* pErrCode);
flag MyTrajectory_ACN_Encode(const MyTrajectory* val, BitStream* pBitStrm, int* pErrCode, flag bCheckConstraints);
flag MyTrajectory_ACN_Decode(MyTrajectory* pVal, BitStream* pBitStrm, int* pErrCode);
flag MyStates_Encode(const MyStates* val, BitStream* pBitStrm, int* pErrCode, flag bCheckConstraints);
flag MyStates_Decode(MyStates* pVal, BitStream* pBitStrm, int* pErrCode);
flag MyStates_ACN_Encode(const MyStates* val, BitStream* pBitStrm, int* pErrCode, flag bCheckConstraints);
