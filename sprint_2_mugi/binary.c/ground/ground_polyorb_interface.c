...
void vm_async_ground_Takeoff(void *Trajectory, size_t Trajectory_len)
{
	switch(__po_hi_get_task_id()) {
		case x86_partition_vt_ground_getheight_k: vm_async_vt_ground_getheight_Takeoff_vt(Trajectory, Trajectory_len); break;
		case x86_partition_vt_ground_gui_polling_ground_k: vm_async_vt_ground_gui_polling_ground_Takeoff_vt(Trajectory, Trajectory_len); break;
		default: break;
	}
}
