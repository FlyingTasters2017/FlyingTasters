...
package body ms_supervisor is
    ...
    type ctxt_Ty is
        ...
        proc_msd_data : aliased asn1SccMyInteger;
        raw_msd_data : aliased asn1SccMyInteger;
    end record;
                ...
                case trId is
                    ...
                    when 1 =>
                        ...
                        if (ctxt.user_input) /= 1 then
                            ...
                            -- NEXT_STATE running (27,30) at 642, 279
                            trId := -1;
                            ctxt.state := running;
                            goto next_transition;
                        end if;
                    when 2 =>
                        ...
                        -- NEXT_STATE running (36,22) at 851, 271
                        trId := -1;
                        ctxt.state := running;
                        goto next_transition;
                    when 3 =>
                        ...
                        if (ctxt.user_input) /= 1 then
                            ...
                            -- NEXT_STATE running (51,30) at 367, 283
                            trId := -1;
                            ctxt.state := running;
                            goto next_transition;
                        end if;
