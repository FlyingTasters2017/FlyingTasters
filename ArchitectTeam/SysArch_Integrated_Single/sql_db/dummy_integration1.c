...
flag PixyData_IsConstraintValid(const PixyData* pVal, int* pErrCode)
{
	...
	*pErrCode=0;
	...
	ret = T_UInt32_IsConstraintValid(&pVal->xPix, pErrCode);
	if (ret) {
	    ret = T_UInt32_IsConstraintValid(&pVal->yPix, pErrCode);
...
flag PixyData_Equal(const PixyData* pVal1, const PixyData* pVal2)
{
	flag ret=TRUE;
	
	ret = T_UInt32_Equal(&pVal1->xPix, &pVal2->xPix);
	if (ret) {
	    ret = T_UInt32_Equal(&pVal1->yPix, &pVal2->yPix);
...
flag PixyData_Encode(const PixyData* pVal, BitStream* pBitStrm, int* pErrCode, flag bCheckConstraints)
{
    flag ret = TRUE;
    
	ret = bCheckConstraints ? PixyData_IsConstraintValid(pVal, pErrCode) : TRUE ;
	if (ret) {
	    /*Encode xPix */
	    ret = T_UInt32_Encode(&pVal->xPix, pBitStrm, pErrCode, FALSE);
	    if (ret) {
	        /*Encode yPix */
	        ret = T_UInt32_Encode(&pVal->yPix, pBitStrm, pErrCode, FALSE);
...
flag PixyData_Decode(PixyData* pVal, BitStream* pBitStrm, int* pErrCode)
{
	...
	/*Decode xPix */
	ret = T_UInt32_Decode(&pVal->xPix, pBitStrm, pErrCode);
	if (ret) {
	    /*Decode yPix */
	    ret = T_UInt32_Decode(&pVal->yPix, pBitStrm, pErrCode);
...
flag PixyData_ACN_Encode(const PixyData* pVal, BitStream* pBitStrm, int* pErrCode, flag bCheckConstraints)
{
    flag ret = TRUE;
	...
	if (ret) {
	    /*Encode xPix */
	    ret = T_UInt32_ACN_Encode(&pVal->xPix, pBitStrm, pErrCode, FALSE);
	    if (ret) {
	        /*Encode yPix */
	        ret = T_UInt32_ACN_Encode(&pVal->yPix, pBitStrm, pErrCode, FALSE);
...
flag PixyData_ACN_Decode(PixyData* pVal, BitStream* pBitStrm, int* pErrCode)
{
    ...
    *pErrCode = 0;
    /*Decode xPix */
    ret = T_UInt32_ACN_Decode(&pVal->xPix, pBitStrm, pErrCode);
    if (ret) {
        /*Decode yPix */
        ret = T_UInt32_ACN_Decode(&pVal->yPix, pBitStrm, pErrCode);
...
{
    *pVal = (Acceleration) {
    .aX = 0.00000000000000000000E+000,
    .aY = 0.00000000000000000000E+000,
    .aZ = 0.00000000000000000000E+000,
    .aRoll = 0.00000000000000000000E+000,
    .aPitch = 0.00000000000000000000E+000,
    .aYaw = 0.00000000000000000000E+000
};
}
#endif

 
flag Acceleration_IsConstraintValid(const Acceleration* pVal, int* pErrCode)
{
	...
	*pErrCode=0;
	...
	ret = MyReal_IsConstraintValid(&pVal->aX, pErrCode);
	if (ret) {
	    ret = MyReal_IsConstraintValid(&pVal->aY, pErrCode);
	    if (ret) {
	        ret = MyReal_IsConstraintValid(&pVal->aZ, pErrCode);
	        if (ret) {
	            ret = MyReal_IsConstraintValid(&pVal->aRoll, pErrCode);
	            if (ret) {
	                ret = MyReal_IsConstraintValid(&pVal->aPitch, pErrCode);
	                if (ret) {
	                    ret = MyReal_IsConstraintValid(&pVal->aYaw, pErrCode);
...
flag Acceleration_Equal(const Acceleration* pVal1, const Acceleration* pVal2)
{
	flag ret=TRUE;
	
	ret = MyReal_Equal(&pVal1->aX, &pVal2->aX);
	if (ret) {
	    ret = MyReal_Equal(&pVal1->aY, &pVal2->aY);
	    if (ret) {
	        ret = MyReal_Equal(&pVal1->aZ, &pVal2->aZ);
	        if (ret) {
	            ret = MyReal_Equal(&pVal1->aRoll, &pVal2->aRoll);
	            if (ret) {
	                ret = MyReal_Equal(&pVal1->aPitch, &pVal2->aPitch);
	                if (ret) {
	                    ret = MyReal_Equal(&pVal1->aYaw, &pVal2->aYaw);
...
flag Acceleration_Encode(const Acceleration* pVal, BitStream* pBitStrm, int* pErrCode, flag bCheckConstraints)
{
    flag ret = TRUE;
    
	ret = bCheckConstraints ? Acceleration_IsConstraintValid(pVal, pErrCode) : TRUE ;
	if (ret) {
	    /*Encode aX */
	    ret = MyReal_Encode(&pVal->aX, pBitStrm, pErrCode, FALSE);
	    if (ret) {
	        /*Encode aY */
	        ret = MyReal_Encode(&pVal->aY, pBitStrm, pErrCode, FALSE);
	        if (ret) {
	            /*Encode aZ */
	            ret = MyReal_Encode(&pVal->aZ, pBitStrm, pErrCode, FALSE);
	            if (ret) {
	                /*Encode aRoll */
	                ret = MyReal_Encode(&pVal->aRoll, pBitStrm, pErrCode, FALSE);
	                if (ret) {
	                    /*Encode aPitch */
	                    ret = MyReal_Encode(&pVal->aPitch, pBitStrm, pErrCode, FALSE);
	                    if (ret) {
	                        /*Encode aYaw */
	                        ret = MyReal_Encode(&pVal->aYaw, pBitStrm, pErrCode, FALSE);
...
flag Acceleration_Decode(Acceleration* pVal, BitStream* pBitStrm, int* pErrCode)
{
	...
	/*Decode aX */
	ret = MyReal_Decode(&pVal->aX, pBitStrm, pErrCode);
	if (ret) {
	    /*Decode aY */
	    ret = MyReal_Decode(&pVal->aY, pBitStrm, pErrCode);
	    if (ret) {
	        /*Decode aZ */
	        ret = MyReal_Decode(&pVal->aZ, pBitStrm, pErrCode);
	        if (ret) {
	            /*Decode aRoll */
	            ret = MyReal_Decode(&pVal->aRoll, pBitStrm, pErrCode);
	            if (ret) {
	                /*Decode aPitch */
	                ret = MyReal_Decode(&pVal->aPitch, pBitStrm, pErrCode);
	                if (ret) {
	                    /*Decode aYaw */
	                    ret = MyReal_Decode(&pVal->aYaw, pBitStrm, pErrCode);
...
flag Acceleration_ACN_Encode(const Acceleration* pVal, BitStream* pBitStrm, int* pErrCode, flag bCheckConstraints)
{
    flag ret = TRUE;
	...
	if (ret) {
	    /*Encode aX */
	    ret = MyReal_ACN_Encode(&pVal->aX, pBitStrm, pErrCode, FALSE);
	    if (ret) {
	        /*Encode aY */
	        ret = MyReal_ACN_Encode(&pVal->aY, pBitStrm, pErrCode, FALSE);
	        if (ret) {
	            /*Encode aZ */
	            ret = MyReal_ACN_Encode(&pVal->aZ, pBitStrm, pErrCode, FALSE);
	            if (ret) {
	                /*Encode aRoll */
	                ret = MyReal_ACN_Encode(&pVal->aRoll, pBitStrm, pErrCode, FALSE);
	                if (ret) {
	                    /*Encode aPitch */
	                    ret = MyReal_ACN_Encode(&pVal->aPitch, pBitStrm, pErrCode, FALSE);
	                    if (ret) {
	                        /*Encode aYaw */
	                        ret = MyReal_ACN_Encode(&pVal->aYaw, pBitStrm, pErrCode, FALSE);
...
flag Acceleration_ACN_Decode(Acceleration* pVal, BitStream* pBitStrm, int* pErrCode)
{
    ...
    *pErrCode = 0;
    /*Decode aX */
    ret = MyReal_ACN_Decode(&pVal->aX, pBitStrm, pErrCode);
    if (ret) {
        /*Decode aY */
        ret = MyReal_ACN_Decode(&pVal->aY, pBitStrm, pErrCode);
        if (ret) {
            /*Decode aZ */
            ret = MyReal_ACN_Decode(&pVal->aZ, pBitStrm, pErrCode);
            if (ret) {
                /*Decode aRoll */
                ret = MyReal_ACN_Decode(&pVal->aRoll, pBitStrm, pErrCode);
                if (ret) {
                    /*Decode aPitch */
                    ret = MyReal_ACN_Decode(&pVal->aPitch, pBitStrm, pErrCode);
                    if (ret) {
                        /*Decode aYaw */
                        ret = MyReal_ACN_Decode(&pVal->aYaw, pBitStrm, pErrCode);
...
void Velocity_Initialize(Velocity* pVal)
{
    *pVal = (Velocity) {
    ...
    .vRoll = 0.00000000000000000000E+000,
    .vPitch = 0.00000000000000000000E+000,
    .vYaw = 0.00000000000000000000E+000
};
}
#endif
	...
	*pErrCode=0;
	...
	if (ret) {
	    ...
	    if (ret) {
	        ...
	        if (ret) {
	            ret = MyReal_IsConstraintValid(&pVal->vRoll, pErrCode);
	            if (ret) {
	                ret = MyReal_IsConstraintValid(&pVal->vPitch, pErrCode);
	                if (ret) {
	                    ret = MyReal_IsConstraintValid(&pVal->vYaw, pErrCode);
...
flag Velocity_Equal(const Velocity* pVal1, const Velocity* pVal2)
{
	...
	if (ret) {
	    ...
	    if (ret) {
	        ...
	        if (ret) {
	            ret = MyReal_Equal(&pVal1->vRoll, &pVal2->vRoll);
	            if (ret) {
	                ret = MyReal_Equal(&pVal1->vPitch, &pVal2->vPitch);
	                if (ret) {
	                    ret = MyReal_Equal(&pVal1->vYaw, &pVal2->vYaw);
	...
	if (ret) {
	    ...
	    if (ret) {
	        ...
	        if (ret) {
	            ...
	            if (ret) {
	                /*Encode vRoll */
	                ret = MyReal_Encode(&pVal->vRoll, pBitStrm, pErrCode, FALSE);
	                if (ret) {
	                    /*Encode vPitch */
	                    ret = MyReal_Encode(&pVal->vPitch, pBitStrm, pErrCode, FALSE);
	                    if (ret) {
	                        /*Encode vYaw */
	                        ret = MyReal_Encode(&pVal->vYaw, pBitStrm, pErrCode, FALSE);
...
flag Velocity_Decode(Velocity* pVal, BitStream* pBitStrm, int* pErrCode)
{
	...
	if (ret) {
	    ...
	    if (ret) {
	        ...
	        if (ret) {
	            /*Decode vRoll */
	            ret = MyReal_Decode(&pVal->vRoll, pBitStrm, pErrCode);
	            if (ret) {
	                /*Decode vPitch */
	                ret = MyReal_Decode(&pVal->vPitch, pBitStrm, pErrCode);
	                if (ret) {
	                    /*Decode vYaw */
	                    ret = MyReal_Decode(&pVal->vYaw, pBitStrm, pErrCode);
	...
	if (ret) {
	    ...
	    if (ret) {
	        ...
	        if (ret) {
	            ...
	            if (ret) {
	                /*Encode vRoll */
	                ret = MyReal_ACN_Encode(&pVal->vRoll, pBitStrm, pErrCode, FALSE);
	                if (ret) {
	                    /*Encode vPitch */
	                    ret = MyReal_ACN_Encode(&pVal->vPitch, pBitStrm, pErrCode, FALSE);
	                    if (ret) {
	                        /*Encode vYaw */
	                        ret = MyReal_ACN_Encode(&pVal->vYaw, pBitStrm, pErrCode, FALSE);
    ...
    *pErrCode = 0;
    ...
    if (ret) {
        ...
        if (ret) {
            ...
            if (ret) {
                /*Decode vRoll */
                ret = MyReal_ACN_Decode(&pVal->vRoll, pBitStrm, pErrCode);
                if (ret) {
                    /*Decode vPitch */
                    ret = MyReal_ACN_Decode(&pVal->vPitch, pBitStrm, pErrCode);
                    if (ret) {
                        /*Decode vYaw */
                        ret = MyReal_ACN_Decode(&pVal->vYaw, pBitStrm, pErrCode);
	    ...
	    if (ret) {
	        ...
	        if (ret) {
	            ...
	            if (ret) {
	                ...
	                if (ret) {
	                    ret = Acceleration_IsConstraintValid(&pVal->currentAcceleration, pErrCode);
	    ...
	    if (ret) {
	        ...
	        if (ret) {
	            ...
	            if (ret) {
	                ...
	                if (ret) {
	                    ret = Acceleration_Equal(&pVal1->currentAcceleration, &pVal2->currentAcceleration);
	        ...
	        if (ret) {
	            ...
	            if (ret) {
	                ...
	                if (ret) {
	                    ...
	                    if (ret) {
	                        /*Encode currentAcceleration */
	                        ret = Acceleration_Encode(&pVal->currentAcceleration, pBitStrm, pErrCode, FALSE);
	    ...
	    if (ret) {
	        ...
	        if (ret) {
	            ...
	            if (ret) {
	                ...
	                if (ret) {
	                    /*Decode currentAcceleration */
	                    ret = Acceleration_Decode(&pVal->currentAcceleration, pBitStrm, pErrCode);
	        ...
	        if (ret) {
	            ...
	            if (ret) {
	                ...
	                if (ret) {
	                    ...
	                    if (ret) {
	                        /*Encode currentAcceleration */
	                        ret = Acceleration_ACN_Encode(&pVal->currentAcceleration, pBitStrm, pErrCode, FALSE);
        ...
        if (ret) {
            ...
            if (ret) {
                ...
                if (ret) {
                    ...
                    if (ret) {
                        /*Decode currentAcceleration */
                        ret = Acceleration_ACN_Decode(&pVal->currentAcceleration, pBitStrm, pErrCode);
...
flag WorldData_IsConstraintValid(const WorldData* pVal, int* pErrCode)
{
	...
	*pErrCode=0;
	...
	ret = Agent_IsConstraintValid(&pVal->agentData, pErrCode);
...
flag WorldData_Equal(const WorldData* pVal1, const WorldData* pVal2)
{
	...
	ret = Agent_Equal(&pVal1->agentData, &pVal2->agentData);
...
flag WorldData_Encode(const WorldData* pVal, BitStream* pBitStrm, int* pErrCode, flag bCheckConstraints)
{
	...
	if (ret) {
	    /*Encode agentData */
	    ret = Agent_Encode(&pVal->agentData, pBitStrm, pErrCode, FALSE);
...
flag WorldData_Decode(WorldData* pVal, BitStream* pBitStrm, int* pErrCode)
{
	...
	/*Decode agentData */
	ret = Agent_Decode(&pVal->agentData, pBitStrm, pErrCode);
...
flag WorldData_ACN_Encode(const WorldData* pVal, BitStream* pBitStrm, int* pErrCode, flag bCheckConstraints)
{
	...
	if (ret) {
	    /*Encode agentData */
	    ret = Agent_ACN_Encode(&pVal->agentData, pBitStrm, pErrCode, FALSE);
...
flag WorldData_ACN_Decode(WorldData* pVal, BitStream* pBitStrm, int* pErrCode)
{
    ...
    *pErrCode = 0;
    /*Decode agentData */
    ret = Agent_ACN_Decode(&pVal->agentData, pBitStrm, pErrCode);
