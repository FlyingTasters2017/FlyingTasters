...
package as_supervisor is
    ...
    procedure RIÜstore_ASD(processed_asd: access asn1SccDroneSensorData);
    pragma import(C, RIÜstore_ASD, "as_supervisor_RI_store_ASD");
    --  Sync required interface "process_ASD"
    procedure RIÜprocess_ASD(raw_ASD: access asn1SccDroneSensorData; processed_ASD: access asn1SccDroneSensorData);
