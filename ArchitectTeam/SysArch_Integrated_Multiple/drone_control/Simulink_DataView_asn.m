...
Trajectory_x_member_data=Simulink.BusElement;
Trajectory_x_member_data.name='element_data';
Trajectory_x_member_data.DataType='double';
Trajectory_x_member_data.dimensions=5;

Trajectory_x=Simulink.Bus;
Trajectory_x.Elements = [Trajectory_x_member_data ];
...
ControlError_elem01=Simulink.BusElement;
ControlError_elem01.name='x';
ControlError_elem01.DataType='double';
ControlError_elem01.dimensions=1;

ControlError_elem02=Simulink.BusElement;
ControlError_elem02.name='y';
ControlError_elem02.DataType='double';
ControlError_elem02.dimensions=1;

ControlError_elem03=Simulink.BusElement;
ControlError_elem03.name='z';
ControlError_elem03.DataType='double';
ControlError_elem03.dimensions=1;

ControlError_elem04=Simulink.BusElement;
ControlError_elem04.name='yaw';
ControlError_elem04.DataType='double';
ControlError_elem04.dimensions=1;

ControlError = Simulink.Bus;
ControlError.Elements = [ControlError_elem01 ControlError_elem02 ControlError_elem03 ControlError_elem04 ];
...
PixyData_xPix_member_data=Simulink.BusElement;
PixyData_xPix_member_data.name='element_data';
PixyData_xPix_member_data.DataType='uint32';
PixyData_xPix_member_data.dimensions=5;

PixyData_xPix=Simulink.Bus;
PixyData_xPix.Elements = [PixyData_xPix_member_data ];
...
SafetyAction_elem01=Simulink.BusElement;
SafetyAction_elem01.name='sPosition';
SafetyAction_elem01.DataType='Position';
SafetyAction_elem01.dimensions=1;

SafetyAction = Simulink.Bus;
SafetyAction.Elements = SafetyAction_elem01 ;
...
Trajectory_y_member_data=Simulink.BusElement;
Trajectory_y_member_data.name='element_data';
Trajectory_y_member_data.DataType='double';
Trajectory_y_member_data.dimensions=5;

Trajectory_y=Simulink.Bus;
Trajectory_y.Elements = [Trajectory_y_member_data ];
...
PositionSystemData_yAct_member_data=Simulink.BusElement;
PositionSystemData_yAct_member_data.name='element_data';
PositionSystemData_yAct_member_data.DataType='double';
PositionSystemData_yAct_member_data.dimensions=5;

PositionSystemData_yAct=Simulink.Bus;
PositionSystemData_yAct.Elements = [PositionSystemData_yAct_member_data ];

MultiControlError_bodyFrameError_member_00=Simulink.BusElement;
MultiControlError_bodyFrameError_member_00.name='element_00';
MultiControlError_bodyFrameError_member_00.DataType='ControlError';
MultiControlError_bodyFrameError_member_00.dimensions=1;

MultiControlError_bodyFrameError_member_01=Simulink.BusElement;
MultiControlError_bodyFrameError_member_01.name='element_01';
MultiControlError_bodyFrameError_member_01.DataType='ControlError';
MultiControlError_bodyFrameError_member_01.dimensions=1;

MultiControlError_bodyFrameError_member_02=Simulink.BusElement;
MultiControlError_bodyFrameError_member_02.name='element_02';
MultiControlError_bodyFrameError_member_02.DataType='ControlError';
MultiControlError_bodyFrameError_member_02.dimensions=1;

MultiControlError_bodyFrameError_member_03=Simulink.BusElement;
MultiControlError_bodyFrameError_member_03.name='element_03';
MultiControlError_bodyFrameError_member_03.DataType='ControlError';
MultiControlError_bodyFrameError_member_03.dimensions=1;

MultiControlError_bodyFrameError_member_04=Simulink.BusElement;
MultiControlError_bodyFrameError_member_04.name='element_04';
MultiControlError_bodyFrameError_member_04.DataType='ControlError';
MultiControlError_bodyFrameError_member_04.dimensions=1;

MultiControlError_bodyFrameError_member_length=Simulink.BusElement;
MultiControlError_bodyFrameError_member_length.name='length';
MultiControlError_bodyFrameError_member_length.DataType='int32';
MultiControlError_bodyFrameError_member_length.dimensions=1;

MultiControlError_bodyFrameError=Simulink.Bus;
MultiControlError_bodyFrameError.Elements = [MultiControlError_bodyFrameError_member_00 MultiControlError_bodyFrameError_member_01 MultiControlError_bodyFrameError_member_02 MultiControlError_bodyFrameError_member_03 MultiControlError_bodyFrameError_member_04 MultiControlError_bodyFrameError_member_length];

SafetyInterupt_sAction_member_00=Simulink.BusElement;
SafetyInterupt_sAction_member_00.name='element_00';
SafetyInterupt_sAction_member_00.DataType='SafetyAction';
SafetyInterupt_sAction_member_00.dimensions=1;

SafetyInterupt_sAction_member_01=Simulink.BusElement;
SafetyInterupt_sAction_member_01.name='element_01';
SafetyInterupt_sAction_member_01.DataType='SafetyAction';
SafetyInterupt_sAction_member_01.dimensions=1;

SafetyInterupt_sAction_member_02=Simulink.BusElement;
SafetyInterupt_sAction_member_02.name='element_02';
SafetyInterupt_sAction_member_02.DataType='SafetyAction';
SafetyInterupt_sAction_member_02.dimensions=1;

SafetyInterupt_sAction_member_03=Simulink.BusElement;
SafetyInterupt_sAction_member_03.name='element_03';
SafetyInterupt_sAction_member_03.DataType='SafetyAction';
SafetyInterupt_sAction_member_03.dimensions=1;

SafetyInterupt_sAction_member_04=Simulink.BusElement;
SafetyInterupt_sAction_member_04.name='element_04';
SafetyInterupt_sAction_member_04.DataType='SafetyAction';
SafetyInterupt_sAction_member_04.dimensions=1;

SafetyInterupt_sAction_member_length=Simulink.BusElement;
SafetyInterupt_sAction_member_length.name='length';
SafetyInterupt_sAction_member_length.DataType='int32';
SafetyInterupt_sAction_member_length.dimensions=1;

SafetyInterupt_sAction=Simulink.Bus;
SafetyInterupt_sAction.Elements = [SafetyInterupt_sAction_member_00 SafetyInterupt_sAction_member_01 SafetyInterupt_sAction_member_02 SafetyInterupt_sAction_member_03 SafetyInterupt_sAction_member_04 SafetyInterupt_sAction_member_length];
...
PixyData_yPix_member_data=Simulink.BusElement;
PixyData_yPix_member_data.name='element_data';
PixyData_yPix_member_data.DataType='uint32';
PixyData_yPix_member_data.dimensions=5;

PixyData_yPix=Simulink.Bus;
PixyData_yPix.Elements = [PixyData_yPix_member_data ];

Trajectory_z_member_data=Simulink.BusElement;
Trajectory_z_member_data.name='element_data';
Trajectory_z_member_data.DataType='double';
Trajectory_z_member_data.dimensions=5;

Trajectory_z=Simulink.Bus;
Trajectory_z.Elements = [Trajectory_z_member_data ];
...
WorldData_agents_member_00=Simulink.BusElement;
WorldData_agents_member_00.name='element_00';
WorldData_agents_member_00.DataType='Agent';
WorldData_agents_member_00.dimensions=1;

WorldData_agents_member_01=Simulink.BusElement;
WorldData_agents_member_01.name='element_01';
WorldData_agents_member_01.DataType='Agent';
WorldData_agents_member_01.dimensions=1;

WorldData_agents_member_02=Simulink.BusElement;
WorldData_agents_member_02.name='element_02';
WorldData_agents_member_02.DataType='Agent';
WorldData_agents_member_02.dimensions=1;

WorldData_agents_member_03=Simulink.BusElement;
WorldData_agents_member_03.name='element_03';
WorldData_agents_member_03.DataType='Agent';
WorldData_agents_member_03.dimensions=1;

WorldData_agents_member_04=Simulink.BusElement;
WorldData_agents_member_04.name='element_04';
WorldData_agents_member_04.DataType='Agent';
WorldData_agents_member_04.dimensions=1;

WorldData_agents_member_length=Simulink.BusElement;
WorldData_agents_member_length.name='length';
WorldData_agents_member_length.DataType='int32';
WorldData_agents_member_length.dimensions=1;

WorldData_agents=Simulink.Bus;
WorldData_agents.Elements = [WorldData_agents_member_00 WorldData_agents_member_01 WorldData_agents_member_02 WorldData_agents_member_03 WorldData_agents_member_04 WorldData_agents_member_length];

WorldData_elem01=Simulink.BusElement;
WorldData_elem01.name='myArea';
WorldData_elem01.DataType='Area';
WorldData_elem01.dimensions=1;

WorldData_elem02=Simulink.BusElement;
WorldData_elem02.name='refPath';
WorldData_elem02.DataType='ReferencePath';
WorldData_elem02.dimensions=1;

WorldData_elem03=Simulink.BusElement;
WorldData_elem03.name='refFormation';
WorldData_elem03.DataType='ReferenceFormation';
WorldData_elem03.dimensions=1;

WorldData_elem04=Simulink.BusElement;
WorldData_elem04.name='agents';
WorldData_elem04.DataType='WorldData_agents';
WorldData_elem04.dimensions=1;

WorldData = Simulink.Bus;
WorldData.Elements = [WorldData_elem01 WorldData_elem02 WorldData_elem03 WorldData_elem04 ];

SafetyInterupt_elem01=Simulink.BusElement;
SafetyInterupt_elem01.name='sEvent';
SafetyInterupt_elem01.DataType='int32';
SafetyInterupt_elem01.dimensions=1;

SafetyInterupt_elem02=Simulink.BusElement;
SafetyInterupt_elem02.name='sAction';
SafetyInterupt_elem02.DataType='SafetyInterupt_sAction';
SafetyInterupt_elem02.dimensions=1;

SafetyInterupt = Simulink.Bus;
SafetyInterupt.Elements = [SafetyInterupt_elem01 SafetyInterupt_elem02 ];
...
PixyData_elem01.DataType='PixyData_xPix';
PixyData_elem01.dimensions=1;

PixyData_elem02=Simulink.BusElement;
PixyData_elem02.name='yPix';
PixyData_elem02.DataType='PixyData_yPix';
PixyData_elem02.dimensions=1;

PixyData = Simulink.Bus;
PixyData.Elements = [PixyData_elem01 PixyData_elem02 ];

Trajectory_yaw_member_data=Simulink.BusElement;
Trajectory_yaw_member_data.name='element_data';
Trajectory_yaw_member_data.DataType='double';
Trajectory_yaw_member_data.dimensions=5;

Trajectory_yaw=Simulink.Bus;
Trajectory_yaw.Elements = [Trajectory_yaw_member_data ];

PositionSystemData_xAct_member_data=Simulink.BusElement;
PositionSystemData_xAct_member_data.name='element_data';
PositionSystemData_xAct_member_data.DataType='double';
PositionSystemData_xAct_member_data.dimensions=5;

PositionSystemData_xAct=Simulink.Bus;
PositionSystemData_xAct.Elements = [PositionSystemData_xAct_member_data ];

PositionSystemData_elem01=Simulink.BusElement;
PositionSystemData_elem01.name='xAct';
PositionSystemData_elem01.DataType='PositionSystemData_xAct';
PositionSystemData_elem01.dimensions=1;

PositionSystemData_elem02=Simulink.BusElement;
PositionSystemData_elem02.name='yAct';
PositionSystemData_elem02.DataType='PositionSystemData_yAct';
...
MultiControlError_elem01=Simulink.BusElement;
MultiControlError_elem01.name='bodyFrameError';
MultiControlError_elem01.DataType='MultiControlError_bodyFrameError';
MultiControlError_elem01.dimensions=1;

MultiControlError = Simulink.Bus;
MultiControlError.Elements = MultiControlError_elem01 ;

Trajectory_elem01=Simulink.BusElement;
Trajectory_elem01.name='x';
Trajectory_elem01.DataType='Trajectory_x';
Trajectory_elem01.dimensions=1;

Trajectory_elem02=Simulink.BusElement;
Trajectory_elem02.name='y';
Trajectory_elem02.DataType='Trajectory_y';
Trajectory_elem02.dimensions=1;

Trajectory_elem03=Simulink.BusElement;
Trajectory_elem03.name='z';
Trajectory_elem03.DataType='Trajectory_z';
Trajectory_elem03.dimensions=1;

Trajectory_elem04=Simulink.BusElement;
Trajectory_elem04.name='yaw';
Trajectory_elem04.DataType='Trajectory_yaw';
