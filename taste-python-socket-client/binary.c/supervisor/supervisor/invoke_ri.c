...
void supervisor_RI_readStabilizerSendThrust(const asn1SccMyReal *IN_ref_thrust)
{
#ifdef __unix__
    ...
    extern void vm_supervisor_readStabilizerSendThrust(void *, size_t);

    vm_supervisor_readStabilizerSendThrust(IN_buf_ref_thrust, size_IN_buf_ref_thrust);
