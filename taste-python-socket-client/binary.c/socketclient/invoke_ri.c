...
void socketclient_RI_check_queue(asn1SccT_Boolean *OUT_res)
{
#ifdef __unix__
    ...
    if (1 == innerMsc) {
        ...
        printf ("\nINNER: socketclient,x86_partition_taste_api,check_queue,%lld\n", msc_time);
        fflush(stdout);
    }
#endif
    ...
    extern void vm_socketclient_check_queue(void *, size_t *);

    vm_socketclient_check_queue(OUT_buf_res, &size_OUT_buf_res);
