...
#ifndef controller_POLYORB_INTERFACE
#define controller_POLYORB_INTERFACE
#include <stddef.h>
...
----------------------------------------------------*/
void sync_controller_Compute_Input(void *, size_t, void *, size_t, void *, size_t, void *, size_t *);
