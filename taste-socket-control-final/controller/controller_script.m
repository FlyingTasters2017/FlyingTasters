...
set_param('controlAction/posData','BusObject','MyPositionControlData');
add_block('simulink/Commonly Used Blocks/Bus Selector','controlAction/posData_MyPositionControlData_BusSel');
add_line('controlAction','posData/1','posData_MyPositionControlData_BusSel/1');
setOutputsBusSelector(MyPositionControlData, 'controlAction/posData_MyPositionControlData_BusSel');
if bussel_positions(1)>0
	set_param('controlAction/posData_MyPositionControlData_BusSel','Position', bussel_positions(1,:));
else
	set_param('controlAction/posData_MyPositionControlData_BusSel','Position',[95 6 100 44]);
end
...
set_param('controlAction/refData','BusObject','MyPositionControlData');
add_block('simulink/Commonly Used Blocks/Bus Selector','controlAction/refData_MyPositionControlData_BusSel');
add_line('controlAction','refData/1','refData_MyPositionControlData_BusSel/1');
setOutputsBusSelector(MyPositionControlData, 'controlAction/refData_MyPositionControlData_BusSel');
if bussel_positions(3)>0
	set_param('controlAction/refData_MyPositionControlData_BusSel','Position', bussel_positions(3,:));
else
	set_param('controlAction/refData_MyPositionControlData_BusSel','Position',[95 206 100 244]);
end
